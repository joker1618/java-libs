...
public class F1ModelImpl extends JkRepoFile implements F1Model {
    ...
    private F1ModelImpl() {
        super(F1Const.DB_FOLDER, F1Const.DB_NAME, "xxx.joker.apps.formula1.old.dataCreator.model.entities");
//        super("fede", F1Const.DB_FOLDER, F1Const.DB_NAME, "xxx.joker.apps.formula1.old.dataCreator.model.entities");
    }
