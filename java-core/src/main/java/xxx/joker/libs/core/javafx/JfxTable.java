...
public class JfxTable {
    ...
    /**
     * This method must be called after set the items for the TableView.
     * The columns are resize used the toString() method, so it works only for text-only columns
     */
